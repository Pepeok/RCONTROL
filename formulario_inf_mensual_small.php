<div class="box-content buttons">
    <h2 > Informe Detalle de Marcaciones  </h2>
    <h3> Debe Seleccionar  todas las casillas!!</h3> 
    <div class="box-content">
        <form class="form-horizontal" action="informe_mensual_small.php" name="form" target="_blank"id="form" method="post">
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label" for="select4" >Linea de Servicio</label>
                    <div class="controls">
                        <?
                ...
                <div class="form-actions">
                    <button type="button" class="btn btn-primary"  formtarget="_blank" onclick="javascript:valida_form_small(this.form);">Consultar</button>
