...
<table class="table table-striped table-bordered bootstrap-datatable datatable "  width="100%">
 ...
 u.nombre , u.apellido, a.fecha_asignado , a.fecha_fin_asignado
...
ORDER BY id_func ASC ; 
 "; 
        ...
        while ($fila = mysql_fetch_array($result)) {
            ...
            $fecha_ing_func = invertirFecha($fila["fecha_asignado"]);
            $fecha_out_func = invertirFecha($fila["fecha_fin_asignado"]);
