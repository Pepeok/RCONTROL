...
$query6.=" WHERE f.rut_func = m.rut_marca  asignado a ";
  ...
  while($fila6=mysql_fetch_array($result6))
    ...
    <tr>
      ...
      <table  class="tabla_bordes" width="100%" border="1" style="border-bottom:none;" cellspacing="0" cellpadding="0">
     		  <? 
       				 $query3=  " SELECT f.rut_func, l.id_ldserv, l.perfil_ldserv, l.sigla_ldserv, COUNT( DISTINCT f.rut_func ) AS prof ";//COUNT( f.id_ldserv_func )as tot_ldserv
					 $query3.= " FROM funcionario f, marcaciones m, ldserv l ";
					 $query3.= " WHERE f.rut_func = m.rut_marca ";
					 $query3.= " AND f.id_ldserv_func = l.id_ldserv ";
					 //$query3.= " AND f.estado_func =1 ";
			...
			<tr align="center">
                ...
                <td width="17.65%"><? echo  $horatotal ; ?></td>
                      <? 
                            ...
                            $query9.=" FROM funcionario f, marcaciones m, ldserv l ";
                            $query9.=" WHERE f.rut_func = m.rut_marca ";
                            $query9.=" AND f.id_ldserv_func = l.id_ldserv ";
                            //$query9.=" AND f.estado_func =1 ";
                            ...
                            $query9.= " AND f.id_dpto_func =".$id_dpto_func." ";
                            $query9.=" ORDER BY f.rut_func, m.fecha_marca ;"; 
                             
                          //$query9; //query que saca el total del mes segun la consulta 
