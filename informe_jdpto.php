...
<table class="table table-striped table-bordered bootstrap-datatable datatable" >
    ...
    $query1 = " SELECT DISTINCT u.id_usuario, u.nombre_usuario, f.id_func, f.nombre_func, f.rut_func ";
    $query1.=" FROM usuario u, asignado a, funcionario f ";
    $query1.=" WHERE u.id_usuario =" . $id_usuario . "";
    $query1.=" AND u.id_usuario = a.id_jefedpto_asignado ";
